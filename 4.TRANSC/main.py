...
#Como não estou em 1.DEC_ENC, redirecionar pasta
sys.path.append('../1.DEC_ENC/CFG/')
	
#Selecionar o arquivo de configuração desejado
if old_decoder == "VP9":
	import CONFIGURATIONS_VP9 as CFG
elif old_decoder == "VP8":
	import CONFIGURATIONS_VP8 as CFG
...
class EXPERIMENT:
	...
	def __init__(self, 
		...
		if (cq == '' and
			...
			codec_path = '/'.join([HOME_PATH, '/../1.DEC_ENC', codec_folder, 'bin/'])
			codec_path = codec_path.replace('//', '/')
